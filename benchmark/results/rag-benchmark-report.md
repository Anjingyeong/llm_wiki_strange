...
| :--- | :---: | :---: | :---: |
| **Hit@1** | 0.182 | 0.273 | **+0.091** |
| **Hit@3** | 0.409 | 0.500 | **+0.091** |
| **Hit@5** | 0.500 | 0.636 | **+0.136** |
| **MRR@5** | 0.311 | 0.401 | **+0.090** |
| **Context Precision@5** | 0.191 | 0.227 | **+0.036** |
| **Keyword Coverage** | 0.345 | 0.515 | **+0.170** |
| **Avg Search Latency** | 1.28ms | 25.78ms | **+24.495**ms |
...
| q012 | WebRTC와 HLS 성능 비교해줘 | 1 | 1 | 0.50 | 0.25 | 📉 **Hybrid Ranked Lower** |
...
| q017 | RTSP 스트림 404 에러의 주된 원인은? | 1 | 1 | 1.00 | 0.50 | 📉 **Hybrid Ranked Lower** |
| q018 | 모니터링 대시보드의 mjpeg 포트 할당 공식은? | 1 | 1 | 0.50 | 0.20 | 📉 **Hybrid Ranked Lower** |
| q019 | ADR-002에서 설계한 메타데이터 분리 장점은? | 1 | 1 | 1.00 | 0.50 | 📉 **Hybrid Ranked Lower** |
...
| q_mjpeg_scope_control | MJPEG로 원복한 결정이 기능 축소가 아니라 우선순위 재조정인 이유는? | 1 | 1 | 0.25 | 1.00 | 📈 **Hybrid Ranked Higher** |
