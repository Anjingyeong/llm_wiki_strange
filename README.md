...
위키와 RAG API는 인앱 접근 키 없이 동작합니다. 공개 배포 보호는 Cloudflare Access/WAF/rate limit 등 배포 경계에서 설정합니다.
...
> [!WARNING]
> Wiki 문서와 RAG API에는 인앱 접근 키가 없습니다. 외부 공개 배포에서는 Cloudflare Access/WAF/rate limit 등 배포 경계에서 보호하세요.
