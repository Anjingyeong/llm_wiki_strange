...
## Manifest
- runId: 20260710-141244280_b5f11c2_structure-aware-contextual
...
| Duplicate count | 158 |
| p50 latency ms | 0.9664 |
| p95 latency ms | 5.0544 |
...
- promote: false
- reasons: n/a
- regressions: no quality gain: recallΔ=-0.0500 mrrΔ=-0.0190 < 0.01; hitAt1 regressed by 0.0200 > 0.02; hitAt5 regressed by 0.0400 > 0.02; recallAt5 regressed by 0.0500 > 0.02; ndcgAt5 regressed by 0.0360 > 0.02; p95 latency increased by 221.1% > 30%; duplicates increased 140 -> 158
