...
- runId: `20260710-142003139_174e3f9_hybrid-stage3`
- Stage-2 anchor: **structure-aware-only** (structure-aware vector-only)
- Selected RRF: k=60, lex=1, vec=1
- Promotion: **true** hybrid-rrf
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| vector-only-structure-aware | 0.56 | 0.78 | 0.5267 | 0.6457 | 0.5219 | 0.9091 | 0.4943 | 140 | 11 | 0 | 0.7781 | 0 |
| lexical-only | 0.64 | 0.76 | 0.5133 | 0.6917 | 0.529 | 0.8182 | 0.5287 | 146 | 6 | 0.4 | 80.068 | 0 |
| hybrid-rrf | 0.62 | 0.8 | 0.55 | 0.6967 | 0.5559 | 0.9091 | 0.523 | 140 | 9 | 1 | 86.1785 | 0.4004 |
| hybrid-diversify-max1 | 0.62 | 0.86 | 0.6767 | 0.7167 | 0.6383 | 1 | 0.6552 | 29 | 12 | 1 | 78.5455 | 0.4004 |
| hybrid-diversify-max2 | 0.62 | 0.86 | 0.6233 | 0.7167 | 0.6093 | 1 | 0.592 | 91 | 12 | 1 | 78.6369 | 0.4004 |
| hybrid-contextual | 0.64 | 0.8 | 0.5133 | 0.705 | 0.534 | 0.9091 | 0.5115 | 149 | 8 | 1 | 89.9838 | 0.4007 |
| hybrid-contextual-diversify-max2 | 0.64 | 0.88 | 0.6133 | 0.7333 | 0.6034 | 1 | 0.592 | 95 | 12 | 1 | 90.7718 | 0.4007 |
...
- lexical-only: promote=false reasons=quality gain recallΔ=-0.0133 mrrΔ=0.0460 regressions=hitAt5 regressed by 0.0200 > 0.02; duplicates increased 140 -> 146
- hybrid-rrf: promote=true reasons=quality gain recallΔ=0.0233 mrrΔ=0.0510 regressions=none
- hybrid-diversify-max1: promote=false reasons=quality gain recallΔ=0.1500 mrrΔ=0.0710 regressions=wrongTop1 increased 11 -> 12
- hybrid-diversify-max2: promote=false reasons=quality gain recallΔ=0.0967 mrrΔ=0.0710 regressions=wrongTop1 increased 11 -> 12
- hybrid-contextual: promote=false reasons=quality gain recallΔ=-0.0133 mrrΔ=0.0593 regressions=duplicates increased 140 -> 149
- hybrid-contextual-diversify-max2: promote=false reasons=quality gain recallΔ=0.0867 mrrΔ=0.0877 regressions=wrongTop1 increased 11 -> 12
