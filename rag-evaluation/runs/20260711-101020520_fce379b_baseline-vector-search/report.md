...
## Manifest
- runId: 20260711-101020520_fce379b_baseline-vector-search
- experiment: baseline-vector-search
- retrievalMode: baseline
- git: main@fce379b dirty=true
...
| Duplicate count | 136 |
| p50 latency ms | 0.9294 |
| p95 latency ms | 2.2918 |
...
## Promotion
- promote: true
- reasons: quality gain recallΔ=0.0100 mrrΔ=0.0000
- regressions: none
