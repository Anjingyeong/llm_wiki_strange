...
## Manifest
- runId: 20260710-142206793_174e3f9_stage3-repro-vector
- experiment: stage3-repro-vector
- retrievalMode: baseline
- git: main@174e3f9 dirty=true
...
| Duplicate count | 140 |
| p50 latency ms | 0.8392 |
| p95 latency ms | 1.4053 |
