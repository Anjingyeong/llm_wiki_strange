...
## Manifest
- runId: 20260710-141306534_b5f11c2_baseline-legacy-chunking
...
| Duplicate count | 166 |
| p50 latency ms | 0.6343 |
| p95 latency ms | 1.5308 |
...
- promote: false
- reasons: n/a
- regressions: no quality gain: recallΔ=0.0000 mrrΔ=0.0000 < 0.01; p95 latency increased by 37.5% > 30%
