...
## Manifest
- runId: 20260710-140744_c5ad4ce_baseline-vector-search
- experiment: baseline-vector-search
- retrievalMode: baseline
- git: main@c5ad4ce dirty=true
...
| Duplicate count | 166 |
| p50 latency ms | 0.7571 |
| p95 latency ms | 2.4749 |
...
## Promotion
- promote: true
- reasons: no prior best — seed best
- regressions: none
